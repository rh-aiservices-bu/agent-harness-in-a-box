#!/bin/bash
# Test OpenShell sandbox security enforcement (standard policy) for Hermes.
...
echo ""
echo "================================================================"
echo " OpenShell Security Test - STANDARD Policy (Hermes)"
...
echo "   PyPI, NousResearch, and GitHub (read-only) are allowed."
...
test_curl "curl https://nousresearch.com (NousResearch)" \
    "https://nousresearch.com" "$SANDBOX_NAME"
track $?
...
echo ""
echo " Network:    PyPI + NousResearch + GitHub RO + MLflow allowed"
